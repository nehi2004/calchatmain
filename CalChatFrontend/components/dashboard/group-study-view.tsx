...
export function GroupStudyView() {
    ...
    useEffect(() => {
        ...
        fetch(`http://localhost:5009/api/chat/mute/${activeChat}`, {
            headers: {
        ...
        const refreshChats = async () => {
            ...
            try {
                const data = await safeFetch<Chat[]>(
                    `http://localhost:5009/api/chat/personal/${currentUserId}`
                )
    ...
    const fetchSentRequests = async () => {
        ...
        try {
            ...
            const res = await safeFetch<string[]>(
                `http://localhost:5009/api/notifications/sent/${currentUserId}`
            )
    ...
    const handleRequest = async (notifId: number, status: string) => {
        ...
        await fetch(`http://localhost:5009/api/notifications/${notifId}`, {
            method: "PUT",
    ...
    const sendRequest = async (studentId: string) => {
        ...
        await fetch("http://localhost:5009/api/notifications/request", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
    ...
    const toggleBlockUser = async () => {
        ...
        try {
            ...
            const url = isBlocked
                ? `http://localhost:5009/api/users/unblock/${profileId}`
                : `http://localhost:5009/api/users/block/${profileId}`
    ...
    useEffect(() => {
        ...
        safeFetch<Student[]>("http://localhost:5009/api/users/students")
            .then(setStudents)
            .catch(() => setStudents([]))
        ...
        const loadChats = async () => {
            ...
            try {
                ...
                if (activeTab === "personal") {
                    ...
                    const data = await safeFetch<Chat[]>(`http://localhost:5009/api/chat/personal/${currentUserId}`)
                    setChats(data)

                } else {

                    const data = await safeFetch<Chat[]>(`http://localhost:5009/api/chat/group/${currentUserId}`)
                    setChats(data)
    ...
    useEffect(() => {
        ...
        const markReadAndRefresh = async () => {
            ...
            await fetch(`http://localhost:5009/api/messages/read/${activeChat}`, {
                method: "POST",
                headers: {
                    UserId: currentUserId,
                    Authorization: `Bearer ${localStorage.getItem("token")}`
            ...
            const res = await fetch(
                `http://localhost:5009/api/messages/${activeChat}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`
                }
            })
    ...
    const createGroup = async () => {
        ...
        const res = await fetch("http://localhost:5009/api/groups", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                name: groupName,
        ...
        const chats = await safeFetch<Chat[]>(`http://localhost:5009/api/chat/group/${currentUserId}`)
        setChats(chats)
    }
    ...
    useEffect(() => {
        ...
        const interval = setInterval(async () => {
            ...
            const res = await fetch(
                `http://localhost:5009/api/chat/typing/${activeChat}`
            )
        ...
        try {
            ...
            await Promise.all(
                selectedStudents.map(studentId =>
                    fetch("http://localhost:5009/api/groups/add-member", {
                        method: "POST",
                        headers: {
            ...
            // 🔥 REFRESH GROUP DATA
            const res = await fetch(`http://localhost:5009/api/groups/${activeChat}`)
            const data = await res.json()
        ...
        const interval = setInterval(async () => {
            ...
            try {
                ...
                const url =
                    activeTab === "personal"
                        ? `http://localhost:5009/api/chat/personal/${currentUserId}`
                        : `http://localhost:5009/api/chat/group/${currentUserId}`
                                ...
                                onClick={() => {
                                    ...
                                    if (activeTab === "personal") {
                                        ...
                                        if (id) {
                                            ...
                                            fetch(`http://localhost:5009/api/users/is-blocked/${id}`, {
                                                headers: {
                                                    Authorization: `Bearer ${localStorage.getItem("token")}`
                                                }
                                            })
                                    ...
                                    if (activeTab === "group" && activeChat) {
                                        ...
                                        fetch(`http://localhost:5009/api/groups/${activeChat}`)
                                            .then(async (res) => {
                                        ...
                                        <span
                                            ...
                                            onClick={async () => {
                                                ...
                                                try {
                                                    ...
                                                    const res = await fetch(
                                                        `http://localhost:5009/api/messages/export/${activeChat}`,
                                                        {
                                                            headers: {
                                                                Authorization: `Bearer ${localStorage.getItem("token")}`
                                                            }
                                    ...
                                    <div className="bg-gray-100 rounded-lg divide-y text-sm">
                                        ...
                                        <button
                                            ...
                                            onClick={async () => {
                                                ...
                                                await fetch(`http://localhost:5009/api/messages/clear/${activeChat}`, {
                                                    method: "DELETE",
                                                    headers: {
                                                        Authorization: `Bearer ${localStorage.getItem("token")}`
                                                    }
                                        ...
                                        <button
                                            ...
                                            onClick={async () => {
                                                ...
                                                try {
                                                    ...
                                                    const res = await fetch(
                                                        `http://localhost:5009/api/chat/mute/${activeChat}`,
                                                        {
                                                            method: "POST",
                                                            headers: {
                                                                "Content-Type": "application/json",
                                    ...
                                    <div className="bg-gray-100 rounded-lg divide-y text-sm">
                                        ...
                                        <button
                                            ...
                                            onClick={async () => {
                                                ...
                                                await fetch(`http://localhost:5009/api/chat/mute/${activeChat}`, {
                                                    method: "POST",
                                                    headers: {
                                                        UserId: currentUserId
                                                    }
                                        ...
                                        <button
                                            ...
                                            onClick={async () => {
                                                ...
                                                if (!activeChat) return
                                                await fetch(`http://localhost:5009/api/groups/exit/${activeChat}`, {
                                                    method: "POST",
                                                    headers: {
                                                        "Content-Type": "application/json",
                            ...
                            >
                                ...
                                {msg.fileUrl && (
                                    ...
                                    msg.fileUrl.match(/\.(jpeg|jpg|png|gif|webp)$/i) ? (
                                        ...
                                        <img
                                            src={`http://localhost:5009${msg.fileUrl}`}
                                            alt="chat-image"
                                            className="rounded-lg mt-2 max-h-60 cursor-pointer"
                                            onClick={() => window.open(`http://localhost:5009${msg.fileUrl}`, "_blank")}
                                        />

                                    ) : (

                                        <a
                                            href={`http://localhost:5009${msg.fileUrl}`}
                                            download
                                            target="_blank"
                        ...
                        <Input
                            ...
                            onChange={(e) => {
                                ...
                                if (connectionRef.current && activeChat) {
                                    ...
                                    fetch("http://localhost:5009/api/chat/typing", {
                                        method: "POST",
                                        headers: {
                                            "Content-Type": "application/json"
                                        },
