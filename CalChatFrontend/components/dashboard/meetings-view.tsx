...
//        const res = await fetch("https://calchatmain-production-7169.up.railway.app/api/meeting/users", {
//            headers: { Authorization: `Bearer ${token}` }
//        })
...
//        const res = await fetch("https://calchatmain-production-7169.up.railway.app/api/meeting/create", {
//            method: "POST",
//            headers: {
...
export function MeetingsView() {
    ...
    const createMeeting = async () => {
        ...
        await fetch("https://calchatmain-production-7169.up.railway.app/api/meeting/create", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`
