...
//        const res = await fetch("http://localhost:5009/api/meeting/users", {
//            headers: { Authorization: `Bearer ${token}` }
//        })
...
//        const res = await fetch("http://localhost:5009/api/meeting/create", {
//            method: "POST",
//            headers: {
...
export function MeetingsView() {
    ...
    const createMeeting = async () => {
        ...
        await fetch("http://localhost:5009/api/meeting/create", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`
