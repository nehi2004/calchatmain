...
export function NotesView() {
    ...
    useEffect(() => {
        if (role?.toLowerCase() === "hr") {
            fetch("https://calchatmain-production-7169.up.railway.app/api/hr/employees", {
                headers: {
    ...
    async function handleSaveNote() {
        ...
        const url = editMode
            ? `https://calchatmain-production-7169.up.railway.app/api/Notes/${editId}`
            : `https://calchatmain-production-7169.up.railway.app/api/Notes/create`
    ...
    const fetchNotes = async () => {
        const res = await fetch("https://calchatmain-production-7169.up.railway.app/api/Notes", {
            headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
        })
    ...
    async function handleDeleteNote(id: string) {
        ...
        const res = await fetch(`https://calchatmain-production-7169.up.railway.app/api/Notes/${id}`, {
            method: "DELETE",
            headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
