...
//                const res = await fetch("https://calchatmain-production-7169.up.railway.app/api/Account/profile", {
//                    headers: {
...
//const EVENT_API = "https://calchatmain-production-7169.up.railway.app/api/CalendarEvents"
...
//                    `https://calchatmain-production-7169.up.railway.app/api/notifications/${currentUserId}`
//                )
...
//    useEffect(() => {
//        fetch("https://calchatmain-production-7169.up.railway.app/api/users/students")
//            .then(res => res.json())
//            .then(setStudents)
//            .catch(() => setStudents([]))
//    }, [])
...
//            const res = await fetch("https://calchatmain-production-7169.up.railway.app/api/meeting/my-meetings", {
//                headers: { Authorization: `Bearer ${token}` }
//            })
...
//        if (status === "accepted") {
//            await fetch("https://calchatmain-production-7169.up.railway.app/api/chat/create", {
//                method: "POST",
//                headers: {
//                    "Content-Type": "application/json"
//                },
...
//            await fetch("https://calchatmain-production-7169.up.railway.app/api/Account/profile", {
//                method: "PUT",
//                headers: {
//                    "Content-Type": "application/json",
//                    Authorization: `Bearer ${token}`
...
//                                    try {
//                                        await fetch(
//                                            `https://calchatmain-production-7169.up.railway.app/api/notifications/mark-read/${currentUserId}`,
//                                            { method: "PUT" }
//                                        )
