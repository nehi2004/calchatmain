...
//                const res = await fetch("http://localhost:5009/api/Account/profile", {
//                    headers: {
...
//                    `http://localhost:5009/api/notifications/${currentUserId}`
//                )
...
//    useEffect(() => {
//        fetch("http://localhost:5009/api/users/students")
//            .then(res => res.json())
//            .then(setStudents)
//            .catch(() => setStudents([]))
//    }, [])
...
//            const res = await fetch("http://localhost:5009/api/meeting/my-meetings", {
//                headers: { Authorization: `Bearer ${token}` }
//            })
...
//        if (status === "accepted") {
//            await fetch("http://localhost:5009/api/chat/create", {
//                method: "POST",
//                headers: {
//                    "Content-Type": "application/json"
//                },
...
//            await fetch("http://localhost:5009/api/Account/profile", {
//                method: "PUT",
//                headers: {
//                    "Content-Type": "application/json",
//                    Authorization: `Bearer ${token}`
...
//                                    try {
//                                        await fetch(
//                                            `http://localhost:5009/api/notifications/mark-read/${currentUserId}`,
//                                            { method: "PUT" }
//                                        )
