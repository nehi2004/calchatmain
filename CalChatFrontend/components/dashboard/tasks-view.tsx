...
//const API_URL = "https://steadfast-warmth-production-31cc.up.railway.app/api/Tasks"
...
export function TasksView() {
    ...
    async function handleAddTask() {
        ...
        if (role === "hr" && selectedUser) {
            ...
            const res = await fetch("https://steadfast-warmth-production-31cc.up.railway.app/api/notifications", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
