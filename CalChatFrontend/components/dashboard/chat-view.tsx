...
//            const res = await fetch("http://localhost:5009/api/ai/chat", {
//                method: "POST",
//                headers: {
...
//                const res = await fetch("http://localhost:5009/api/ai/history", {
//                    method: "GET",
//                    headers: {
//                        "Content-Type": "application/json",
//                        Authorization: `Bearer ${token}`
...
//            await fetch("http://localhost:5009/api/CalendarEvents", {
//                method: "POST",
//                headers: {
//                    "Content-Type": "application/json",
//                    Authorization: `Bearer ${token}`
...
//            await fetch("http://localhost:5009/api/ai/save-action", {
//                method: "POST",
//                headers: {
//                    "Content-Type": "application/json",
//                    Authorization: `Bearer ${token}`
