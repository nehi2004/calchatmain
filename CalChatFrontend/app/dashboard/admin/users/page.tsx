...
//            const res = await fetch("https://calchatmain-production-7169.up.railway.app/api/users", {
//                headers: {
...
//            const res = await fetch("https://calchatmain-production-7169.up.railway.app/api/account/users", {
//                headers: {
//                    Authorization: `Bearer ${token}`
//                }
//            })
...
//        await fetch(`https://calchatmain-production-7169.up.railway.app/api/account/users/${user.id}`, {
//            method: "PUT",
//            headers: {
...
//        await fetch(`https://calchatmain-production-7169.up.railway.app/api/account/users/${userId}/deactivate`, {
//            method: "PUT",
//            headers: {
//                Authorization: `Bearer ${token}`
//            }
...
//        await fetch(`https://calchatmain-production-7169.up.railway.app/api/account/send-email`, {
//            method: "POST",
//            headers: {
//                "Content-Type": "application/json",
//                Authorization: `Bearer ${token}`
