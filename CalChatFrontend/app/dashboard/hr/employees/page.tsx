...
//            const res = await fetch(`https://steadfast-warmth-production-64c8.up.railway.app/api/hr/delete-employee/${id}`, {
//                method: "DELETE",
//                headers: {
//                    Authorization: `Bearer ${token}`
//                }
...
//            const res = await fetch(`https://steadfast-warmth-production-64c8.up.railway.app/api/hr/update-employee/${editId}`, {
//                method: "PUT",
//                headers: {
//                    "Content-Type": "application/json",
//                    Authorization: `Bearer ${token}`
...
//            const res = await fetch(`https://steadfast-warmth-production-64c8.up.railway.app/api/hr/resend-invite/${userId}`, {
//                method: "POST",
//                headers: {
//                    Authorization: `Bearer ${token}`
//                }
