...
//                `https://steadfast-warmth-production-31cc.up.railway.app/api/chat/personal/${userId}`,
//                {
//                    headers: {
...
//            await fetch("https://steadfast-warmth-production-31cc.up.railway.app/api/messages", {
//                method: "POST",
//                headers: {
...
//            const res = await fetch("https://steadfast-warmth-production-31cc.up.railway.app/api/users/students", {
//                headers: {
//                    Authorization: `Bearer ${token}`
//                }
//            })
...
//            const res = await fetch(
//                `https://steadfast-warmth-production-31cc.up.railway.app/api/chat/personal/${activeUser.id}`,
//                {
//                    headers: {
//                        Authorization: `Bearer ${token}`
//                    }
